...
const Settings: React.FC<SettingsProps> = ({ session, onSignOut }) => {
    const getQrCodeUrl = () => {
        ...
        const loginUrl = `${window.location.origin}/?access_token=${session.access_token}&refresh_token=${session.refresh_token}&type=qr_login`;
        // Encode for QR API
    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8 animate-fade-in">
             <div className="text-center mb-8">
                ...
                <p className="text-slate-400">Manage your account and devices.</p>
            </div>

            <div className="bg-slate-800 rounded-xl shadow-lg border border-slate-700 overflow-hidden">
                 <div className="p-6 border-b border-slate-700">
                     <h2 className="text-xl font-bold text-white flex items-center">
                         <User className="w-5 h-5 mr-2 text-indigo-400"/> Account Info
                     </h2>
                 </div>
                 <div className="p-6">
                     <div className="mb-4">
            ...
            <div className="bg-slate-800 rounded-xl shadow-lg border border-slate-700 overflow-hidden">
                 <div className="p-6 border-b border-slate-700">
                     <h2 className="text-xl font-bold text-white flex items-center">
                         <Smartphone className="w-5 h-5 mr-2 text-indigo-400"/> Connect Another Device
                     </h2>
                 </div>
                 <div className="p-6 flex flex-col items-center text-center">
                     <p className="text-gray-300 mb-6">Scan this QR code with your phone camera or another device to instantly log in.</p>
                     ...
                     <p className="text-xs text-yellow-500/80 max-w-sm">
                         Warning: Do not share this QR code. It contains access to your account.
                     </p>
                 </div>
            </div>
        </div>
